			...
			<div id="fh5co-blog">
				<div class="container">
					<div class="fh5co-section-heading">
						<h2 class="text-muted">Projetos de iluminação</h2>
					</div>
					<div class="row">
						...
						<div class="col-md-12 col-sm-12">
							<article class="fh5co-post-entry">
								<p class="paragraph">Para o desenvolvimento de um bom projeto de iluminação é necessário preocupar-se com diversos fatores. Dentre eles podemos citar:
									<ul>
										<li>Ambiente;</li>
										<li>Tipo de trabalho a ser executado neste local;</li>
										<li>Valor de luminância mínimo;</li>
