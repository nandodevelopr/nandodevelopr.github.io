			...
			<div id="fh5co-blog">
				<div class="container">
					<div class="fh5co-section-heading">
						<h2 class="text-muted">Projetos elétricos</h2>
					</div>
					<div class="row">
						...
						<div class="col-md-12 col-sm-12">
							<article class="fh5co-post-entry">
								<p class="paragraph">A elaboração e desenvolvimento de projetos elétricos é uma das especialidades da PEMAC Engenharia, o projeto elétrico nada mais é que a representação visual e escrita das instalações elétricas de um empreendimento (residencial, comercial ou industrial)...</p>
							</article>
						</div>
