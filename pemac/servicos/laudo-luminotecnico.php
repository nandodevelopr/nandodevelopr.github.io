			...
			<div id="fh5co-blog">
				<div class="container">
					<div class="fh5co-section-heading">
						<h2 class="text-muted">Laudo luminotécnico (laudo de iluminação)</h2>
					</div>
					<div class="row">
						...
						<div class="col-md-12 col-sm-12">
							<article class="fh5co-post-entry">
								<p class="paragraph">O Laudo Luminotécnico é o relatório de inspeção e medição que busca aferir se os níveis de iluminação estão de acordo com a nova norma NBR 8995-1:2013...</p>
							</article>
						</div>
